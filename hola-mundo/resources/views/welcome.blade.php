...
<head>
    ...
    <title>Pruebas de laravel</title>
</head>
<body>
    <hr>
    <hr>
    ...
    <hr>
    <hr>
    <h1 style="text-align: center; color: rgb(0, 0, 0);"> HOLA MUNDO EC2 LARAVEL FUNCIONA</h1>
    <hr>
    <hr>
    <hr>
    <hr>
    ...
    <hr>
    <hr>
    <h1 style="text-align: center; color: rgb(144, 32, 32);">Funciona Dominio</h1>
    <hr>
    <hr>
    <hr>
    <hr>
